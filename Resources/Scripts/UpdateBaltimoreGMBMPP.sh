...
git pull
cat Title.asc ITPolicies.asc DigitalCommunicationsPolicy.asc CampaignsCommitteeBylaws.asc > index.asc
asciidoctor -d book index.asc
sed -i '7a\<link rel="shortcut icon" type="image/ico" href="../../Resources/Images/favicon.ico"/>\n<a href="BaltimoreGMBMPP.pdf"><div class="fab"><img src="../../Resources/Images/pdf-button.png" alt="Print-Friendly PDF"></div></a>\n<link rel="stylesheet" type="text/css" href="../../Resources/Styles/IWW-Docs.css">' index.html
